=== Fetch List of Deployable Contract `artifact.json` Files
...
[%collapsible]
====
include::{snippets}/ContractDecoratorControllerApiTest/mustCorrectlyFetchContractArtifactsWithFilters/http-request.adoc[]
====

.Response Example
[%collapsible]
====
include::{snippets}/ContractDecoratorControllerApiTest/mustCorrectlyFetchContractArtifactsWithFilters/http-response.adoc[]
====
.Response Schema
include::{snippets}/dev3.blockchainapiservice.features.contract.deployment.model.response.ArtifactJsonsResponse.adoc[]
