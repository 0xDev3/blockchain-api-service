...
.Request Schema
include::{snippets}/dev3.blockchainapiservice.features.asset.send.model.request.CreateAssetSendRequest.adoc[]
.Response Schema
include::{snippets}/dev3.blockchainapiservice.features.asset.send.model.response.AssetSendRequestResponse.adoc[]
