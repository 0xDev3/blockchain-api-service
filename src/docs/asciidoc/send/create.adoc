...
.Request Schema
include::{snippets}/dev3.blockchainapiservice.model.request.CreateAssetSendRequest.adoc[]
.Response Schema
include::{snippets}/dev3.blockchainapiservice.model.response.AssetSendRequestResponse.adoc[]
