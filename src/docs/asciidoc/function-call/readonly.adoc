...
.Request Schema
include::{snippets}/dev3.blockchainapiservice.features.contract.readcall.model.request.ReadonlyFunctionCallRequest.adoc[]
.Response Schema
include::{snippets}/dev3.blockchainapiservice.features.contract.readcall.model.response.ReadonlyFunctionCallResponse.adoc[]
