...
.Request Schema
include::{snippets}/dev3.blockchainapiservice.features.contract.functioncall.model.request.CreateContractFunctionCallRequest.adoc[]
.Response Schema
include::{snippets}/dev3.blockchainapiservice.features.contract.functioncall.model.response.ContractFunctionCallRequestResponse.adoc[]
