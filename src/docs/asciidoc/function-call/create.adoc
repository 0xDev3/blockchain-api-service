...
.Request Schema
include::{snippets}/dev3.blockchainapiservice.model.request.CreateContractFunctionCallRequest.adoc[]
.Response Schema
include::{snippets}/dev3.blockchainapiservice.model.response.ContractFunctionCallRequestResponse.adoc[]
