...
.Request Schema
include::{snippets}/dev3.blockchainapiservice.features.asset.lock.model.request.CreateErc20LockRequest.adoc[]
.Response Schema
include::{snippets}/dev3.blockchainapiservice.features.asset.lock.model.response.Erc20LockRequestResponse.adoc[]
