...
.Request Schema
include::{snippets}/dev3.blockchainapiservice.model.request.CreateAssetBalanceRequest.adoc[]
.Response Schema
include::{snippets}/dev3.blockchainapiservice.model.response.AssetBalanceRequestResponse.adoc[]
