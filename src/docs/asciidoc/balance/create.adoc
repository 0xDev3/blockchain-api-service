...
.Request Schema
include::{snippets}/dev3.blockchainapiservice.features.asset.balance.model.request.CreateAssetBalanceRequest.adoc[]
.Response Schema
include::{snippets}/dev3.blockchainapiservice.features.asset.balance.model.response.AssetBalanceRequestResponse.adoc[]
