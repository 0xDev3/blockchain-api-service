...
[%collapsible]
====
include::{snippets}/Erc20BalanceRequestControllerApiTest/mustCorrectlyCreateErc20BalanceRequestForSomeTokenWithRedirectUrl/http-request.adoc[]
====
.Response Example
[%collapsible]
====
include::{snippets}/Erc20BalanceRequestControllerApiTest/mustCorrectlyCreateErc20BalanceRequestForSomeTokenWithRedirectUrl/http-response.adoc[]
====
