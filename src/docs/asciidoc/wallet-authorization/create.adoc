...
.Request Schema
include::{snippets}/dev3.blockchainapiservice.features.wallet.authorization.model.request.CreateAuthorizationRequest.adoc[]
.Response Schema
include::{snippets}/dev3.blockchainapiservice.features.wallet.authorization.model.response.AuthorizationRequestResponse.adoc[]
