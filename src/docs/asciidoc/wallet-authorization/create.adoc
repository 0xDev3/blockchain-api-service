...
.Request Schema
include::{snippets}/dev3.blockchainapiservice.model.request.CreateAuthorizationRequest.adoc[]
.Response Schema
include::{snippets}/dev3.blockchainapiservice.model.response.AuthorizationRequestResponse.adoc[]
