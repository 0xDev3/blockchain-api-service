...
Creates send ERC20 request with specified parameters. Either `client_id` or `chain_id`, `redirect_url` and
...
.Request
include::{snippets}/SendErc20RequestControllerApiTest/mustCorrectlyCreateSendErc20RequestViaChainIdRedirectUrlAndTokenAddress/http-request.adoc[]
.Response
include::{snippets}/SendErc20RequestControllerApiTest/mustCorrectlyCreateSendErc20RequestViaChainIdRedirectUrlAndTokenAddress/http-response.adoc[]
