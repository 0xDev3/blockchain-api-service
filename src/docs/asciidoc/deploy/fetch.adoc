...
[%collapsible]
====
include::{snippets}/ContractDeploymentRequestControllerApiTest/mustCorrectlyFetchContractDeploymentRequest/http-request.adoc[]
====

.Response Example
[%collapsible]
====
include::{snippets}/ContractDeploymentRequestControllerApiTest/mustCorrectlyFetchContractDeploymentRequest/http-response.adoc[]
====
.Response Schema
