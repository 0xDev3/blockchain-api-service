...
====
.Request Schema
include::{snippets}/dev3.blockchainapiservice.model.request.ImportedContractInterfacesRequest.adoc[]
...
====
.Response Schema
include::{snippets}/dev3.blockchainapiservice.model.response.ContractDeploymentRequestResponse.adoc[]
