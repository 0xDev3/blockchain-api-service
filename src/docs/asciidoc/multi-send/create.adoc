...
.Request Schema
include::{snippets}/com.ampnet.blockchainapiservice.model.request.CreateAssetMultiSendRequest.adoc[]
.Response Schema
include::{snippets}/com.ampnet.blockchainapiservice.model.response.AssetMultiSendRequestResponse.adoc[]
