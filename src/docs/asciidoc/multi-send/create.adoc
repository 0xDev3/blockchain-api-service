...
.Request Schema
include::{snippets}/dev3.blockchainapiservice.features.asset.multisend.model.request.CreateAssetMultiSendRequest.adoc[]
.Response Schema
include::{snippets}/dev3.blockchainapiservice.features.asset.multisend.model.response.AssetMultiSendRequestResponse.adoc[]
