...
import org.web3j.abi.FixedDefaultFunctionReturnDecoder;
...
public abstract class FixedContract extends ManagedTransaction {
    ...
    private List<Type> executeCall(Function function) throws IOException {
        ...
        return new FixedDefaultFunctionReturnDecoder().decodeFunctionResult(value, function.getOutputParameters());
    }
    ...
    private static <T extends FixedContract> T create(
    ...
    protected static <T extends FixedContract> T deploy(
            Class<T> type,
            Web3j web3j,
            Credentials credentials,
    ...
    public static <T extends FixedContract> RemoteCall<T> deployRemoteCall(
            Class<T> type,
            Web3j web3j,
            Credentials credentials,
            BigInteger gasPrice,
