...
@Repository
class JooqProjectIdResolverRepository(private val dslContext: DSLContext) : ProjectIdResolverRepository {

    companion object : KLogging()

    // we want compiler type-safety of exhaustive matching of enum elements, so there is no way to reduce complexity
    @Suppress("ComplexMethod")
    override fun getProjectId(idType: IdType, id: UUID): UUID? {
